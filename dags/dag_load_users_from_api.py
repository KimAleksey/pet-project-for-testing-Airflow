...
def load_data_to_tmp_table(**context):
    ...
    values_str = f"""
        '{user_data['login']['uuid']}',
         ...
         '{user_data['name']['title'].replace("'", "''")}',
         '{user_data['name']['first'].replace("'", "''")}',
         '{user_data['name']['last'].replace("'", "''")}',
          {user_data['location']['street']['number']},
         '{user_data['location']['street']['name'].replace("'", "''")}',
         '{user_data['location']['city'].replace("'", "''")}',
         '{user_data['location']['state'].replace("'", "''")}',
         '{user_data['location']['country'].replace("'", "''")}',
